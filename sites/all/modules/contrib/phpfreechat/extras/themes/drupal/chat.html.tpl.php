<!-- $Id: chat.html.tpl.php,v 1.1.2.2.2.1 2009/01/23 03:12:15 permutations Exp $ -->
...
<?php } ?>
      ...
      <div class="pfc_btn">
        <img src="<?php echo $c->getFileUrlFromTheme('images/away-off.gif'); ?>" 
          alt="Set away status on"
		  title="Set away status on"
          id="pfc_onOffAwayBtn"
          onClick="pfc.sendRequest('/away');" />
      </div>
