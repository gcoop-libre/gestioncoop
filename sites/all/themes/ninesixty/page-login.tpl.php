...
<?php if (!empty($admin)) print $admin; ?> 
  ...
  <div id="page" class="container-16 clear-block">
   ...
   <div id="main-top" class="grid-16">
    ...
    <?php endif; ?>
    <?php if ($search_box): ?>
         <div id="search-box" class="grid-3 omega prefix-1"><?php print $search_box; ?></div> <!-- Cierra Serch Box -->
         <?php endif; ?>
   </div> <!-- Cierra Main-top -->
...
<div id="wrapper" class="grid-16">
  ...
  <?php if ($right): ?>
    <div id="sidebar-right" class="column sidebar region grid-3 prefix-1">
      <?php print $right; ?>
    </div>
  <?php endif; ?>
  ...
  <div id="footer" class="grid-16 alpha omega">
    <?php if ($footer): ?>
      <div id="footer-region" class="region grid-16">
        <?php print $footer; ?>
      </div>
    <?php endif; ?>
